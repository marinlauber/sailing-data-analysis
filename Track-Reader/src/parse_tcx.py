...
POINTS_COLUMN_NAMES = ['latitude', 'longitude', 'elevation', 'time', 'heart_rate', 'cadence', 'speed', 'heading', 'lap']
...
def get_dataframe_from_tcx(fname: str) -> Tuple[pd.DataFrame, pd.DataFrame]:
    ...
    # append a heading column
    points_df.heading = calculate_compass_heading(points_df.latitude.values,
...
if __name__ == '__main__':
    ...
    laps_df, points_df = get_dataframe_from_tcx(fname)
    print('LAPS:')
    print(laps_df)
    print('\nPOINTS:')
    print(points_df)
